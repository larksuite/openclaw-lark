...
import { registerFeishuImPinTool } from './pin';
...
export function registerFeishuImTools(api: OpenClawPluginApi) {
  ...
  registerFeishuImPinTool(api);

  api.logger.info?.(
    'feishu_im: Registered feishu_im_user_message, feishu_im_user_fetch_resource, feishu_im_user_get_messages, feishu_im_user_get_thread_messages, feishu_im_user_search_messages, feishu_im_pin',
  );
}
